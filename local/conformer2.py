...
class ConformerBlock(nn.Module):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        self.ff1 = FeedForward(dim = dim, hidden_size=ff_hidden_size, dropout = ff_dropout)
        ...
        self.ff2 = FeedForward(dim = dim, hidden_size=ff_hidden_size, dropout = ff_dropout)
...
if __name__ == '__main__':
    net = Conformer(dim=128*20, depth=6, conv_kernel_size=15, ff_dropout=0.1).cuda()
    data = torch.randn(4, 128*20, 800).cuda()
    print(data.shape)
